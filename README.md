...
Therefore, this package aims to provide an improved functionality of querying by _making it possible for users to fetch stock data by __company name(s) alone!__ <br><br>
